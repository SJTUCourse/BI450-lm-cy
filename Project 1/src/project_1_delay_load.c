 ...
 */
FARPROC WINAPI project_1DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = project_1DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = project_1DelayLoadWin32FailureHook;
#endif
