% PulseOutputwithTimerInterrupt.m
%
% Example Category:
%    Counter
...
%
% Description:
%    This example demonstrates how to use Pulse Output with Timer 
%    Interrupt function.
%
...
try
    ...
    timerPulseCtrl.ChannelCount = 1;
    timerPulseCtrl.ChannelStart = channel;
