...
try
    ...
    udCounterCtrl.CompareSetTable(channel, comValueTab.GetLength(1), ...
        strArray);
    ...
    udCounterCtrl.CompareClear(channel);
...
if isempty(evntID)
evntID = NET.createArray('Automation.BDaq.EventId', 8);
evntID.Set(0, Automation.BDaq.EventId.EvtCntCompareTableEnd0);
evntID.Set(1, Automation.BDaq.EventId.EvtCntCompareTableEnd1);
evntID.Set(2, Automation.BDaq.EventId.EvtCntCompareTableEnd2);
evntID.Set(3, Automation.BDaq.EventId.EvtCntCompareTableEnd3);
evntID.Set(4, Automation.BDaq.EventId.EvtCntCompareTableEnd4);
evntID.Set(5, Automation.BDaq.EventId.EvtCntCompareTableEnd5);
evntID.Set(6, Automation.BDaq.EventId.EvtCntCompareTableEnd6);
evntID.Set(7, Automation.BDaq.EventId.EvtCntCompareTableEnd7);
end
if isempty(evntCompID)
evntCompID = NET.createArray('Automation.BDaq.EventId', 8);
evntCompID.Set(0, Automation.BDaq.EventId.EvtCntPatternMatch0);
evntCompID.Set(1, Automation.BDaq.EventId.EvtCntPatternMatch1);
evntCompID.Set(2, Automation.BDaq.EventId.EvtCntPatternMatch2);
evntCompID.Set(3, Automation.BDaq.EventId.EvtCntPatternMatch3);
evntCompID.Set(4, Automation.BDaq.EventId.EvtCntPatternMatch4);
evntCompID.Set(5, Automation.BDaq.EventId.EvtCntPatternMatch5);
evntCompID.Set(6, Automation.BDaq.EventId.EvtCntPatternMatch6);
evntCompID.Set(7, Automation.BDaq.EventId.EvtCntPatternMatch7);
end

channel = sender.ChannelStart;
udCounterCtrl = sender;
if (evntCompID.Get(channel) == e.Id)||(evntID.Get(channel) == e.Id)
