...
try
    ...
    scaledData = NET.createArray('System.Double', sectionLength*sectionCount);
    errorCode = waveformAiCtrl.GetData(sectionLength*sectionCount,scaledData,-1);%-1 means waiting for filling up the buffer.
